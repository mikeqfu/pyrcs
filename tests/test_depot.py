...
if __name__ == '__main__':
    ...
    print(f"\n  {depots.TCTKey}:\n    {type(two_char_tops_codes_data1_)}, "
          f"{two_char_tops_codes_data1_.shape}")
    ...
    two_char_tops_codes_data2 = depots.fetch_two_char_tops_codes(
    ...
    four_digit_pre_tops_codes_data2 = depots.fetch_four_digit_pre_tops_codes(
        update=True, pickle_it=True, data_dir=test_data_dir)
    four_digit_pre_tops_codes_data2_ = four_digit_pre_tops_codes_data2[depots.FDPTKey]
    print("\n    {} data is consistent:".format(depots.FDPTKey),
          all((x == y) for x, y in zip(four_digit_pre_tops_codes_data1_,
                                       four_digit_pre_tops_codes_data2_)))
    ...
    print(f"\n  {depots.S1950Key}:\n    {type(system_1950_codes_data1_)}, "
          f"{system_1950_codes_data1_.shape}")
    print(f"\n    {depots.LUDKey}: {two_char_tops_codes_data1[depots.LUDKey]}")
    ...
    system_1950_codes_data2 = depots.fetch_1950_system_codes(
        update=True, pickle_it=True, data_dir=test_data_dir)
    ...
    gwr_codes_data2 = depots.fetch_gwr_codes(
        update=True, pickle_it=True, data_dir=test_data_dir)
