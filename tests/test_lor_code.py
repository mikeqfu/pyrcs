...
if __name__ == '__main__':
    ...
    print(f"\n  {lor.ELCKey}:\n    {type(elr_lor_converter1_)}, {elr_lor_converter1_.shape}")
    ...
    elr_lor_converter2 = lor.fetch_elr_lor_converter(update=True, pickle_it=True, data_dir=test_data_dir)
    elr_lor_converter2_ = elr_lor_converter2[lor.ELCKey]
    print("\n    {} data is consistent:".format(lor.ELCKey), elr_lor_converter1_.equals(elr_lor_converter2_))
    ...
    lor_codes_data2 = lor.fetch_lor_codes(update=True, pickle_it=True, data_dir=test_data_dir)
