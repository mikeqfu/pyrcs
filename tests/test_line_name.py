...
if __name__ == '__main__':
    ...
    print(f"\n  {line_names.Key}:\n    {type(line_names_data1_)}, "
          f"{line_names_data1_.shape}")
    ...
    line_names_data2 = line_names.fetch_line_names(
        update=True, pickle_it=True, data_dir=test_data_dir)
    line_names_data2_ = line_names_data2[line_names.Key]

    print("\n    {} data is consistent:".format(line_names.Key),
          line_names_data1_.equals(line_names_data2_))
