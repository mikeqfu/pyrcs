...
The PyRCS documentation (incl. detailed examples and a quick-start tutorial) is hosted on `ReadTheDocs <https://readthedocs.org/projects/pyrcs/>`_: [`HTML <https://pyrcs.readthedocs.io/en/latest/>`_] [`PDF <https://pyrcs.readthedocs.io/_/downloads/en/latest/pdf/>`_].
